...
function loadFlash() {
  const raw = (cookies() as unknown as UnsafeUnwrappedCookies).get("dropx_cod_validation_flash")?.value;
...
export default async function CodValidationPage(props: { searchParams?: Promise<SearchParams> }) {
