...
export default async function CapacityStationPage(
  props: { params: Promise<{ station: string }>; searchParams?: Promise<SearchParams> }
) {
  ...
  return (
    <AppShell active="Capacity" pageCode="cps_associates"><div className="ops-command-center capacity-workspace">
