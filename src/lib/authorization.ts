...
const groupedParentPermissions: Record<string, string[]> = {
  ...
  ops_pulse: ["daily_submission", "cod", "cod_executive_reconciliation", "cod_submission", "cod_validation", "cod_reports", "cod_portal_checks", "cod_cash_in_associate"],
